...
class MotorhomeSpider(scrapy.Spider):
    name = 'motorhome_spider1'
    start_urls = ['https://www.mobile.de/es/autocaravana/peugeot/vhc:motorhome,srt:date,sro:desc,mke:19300,dmg:false&SORT_BY=yearOfRegistration_desc']
